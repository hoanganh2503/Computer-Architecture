...
.data
	...
	;t_rexcopter image
	t_rex_image_1  db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,0fh,0fh,00h,00h,00h,00h,00h,00h,00h ;19x9
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,0fh,0fh,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,0fh,00h,00h,0fh,00h,00h,00h,00h,00h,00h,00h,00h,00h,00h
				   db 00h,00h,00h,00h,00h,0fh,0fh,00h,0fh,0fh,00h,00h,00h,00h,00h,00h,00h,00h,00h
 
    cactus_image    db 00h,00h,00h,0fh,0fh,00h,00h,00h,00h    ; 12x9
					db 00h,00h,00h,0fh,0fh,00h,00h,00h,0fh	
					db 00h,00h,00h,0fh,0fh,00h,00h,00h,0fh
					db 0fh,00h,00h,0fh,0fh,00h,00h,0fh,0fh
					db 0fh,00h,00h,0fh,0fh,00h,0fh,0fh,00h
					db 0fh,00h,00h,0fh,0fh,0fh,0fh,00h,00h
					db 0fh,00h,00h,0fh,0fh,0fh,00h,00h,00h
					db 0fh,0fh,00h,0fh,0fh,00h,00h,00h,00h
					db 00h,0fh,0fh,0fh,0fh,00h,00h,00h,00h
					db 00h,00h,0fh,0fh,0fh,00h,00h,00h,00h
					db 00h,00h,00h,0fh,0fh,00h,00h,00h,00h
					db 00h,00h,00h,0fh,0fh,00h,00h,00h,00h
...
initialize_variable proc	
	mov t_rex_x,50 			
	mov t_rex_y,170			
	mov t_rex_fall_speed,3
	mov t_rex_jump_speed,33
	mov t_rex_width,18       
	mov t_rex_height,8		
	mov map_velocity,10	
	mov map_gradient,1		
...
update_difficulty proc		
	...
	phase_2:
		...
		ret
	phase_3:
        mov map_velocity, 10; tăng tốc độ di chuyển lên 10
		sub bottom_map_pos_y[319],4
		ret
	phase_4:
		mov map_velocity, 12; tăng tốc độ di chuyển lên 12
		mov lose_cactus_score_mark,75
		ret
	phase_5:
		mov map_velocity, 16; tăng tốc độ di chuyển lên 16
		ret
	phase_6:
		mov map_velocity,18; tăng tốc độ di chuyển lên 18
		mov lose_cactus_score_mark,50
		ret
	phase_7:
		mov map_velocity,20; tăng tốc độ di chuyển lên 20
		mov map_gradient, 3
		ret
